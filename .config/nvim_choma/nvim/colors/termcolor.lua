...
vim.api.nvim_set_hl(0, 'TabLineFill', { ctermfg = 0, ctermbg = 'NONE' })
vim.api.nvim_set_hl(0, 'TabLineSel', { ctermfg = 0, ctermbg = 11 })
...
vim.api.nvim_set_hl(0, 'Pmenu', { ctermbg = 7, ctermfg = 8})
