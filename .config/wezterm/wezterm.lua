...
-- config.front_end="WebGpu" -- I don't see the difference
config.freetype_load_target = "Light" -- this solves the font rendering problem in archlinux
config.font = wezterm.font_with_fallback({
  {family = "UbuntuMono Nerd Font Propo", weight="Regular"},
